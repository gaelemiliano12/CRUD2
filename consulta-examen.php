...
<header class="header header-mini"> 
    <div class="header-title">Tabla examen</div> 
    ...
    <table  class="table table-bordered" style="width: 70%; margin: 0 auto; border-collapse: collapse; border: 1px solid #ccc;">
      <thead>
        <tr>
          ...
          <th scope="col" style="border: 1px solid #ccc; padding: 8px;">TIPO</th>
      ...
      <tbody>
        ...
        if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
            echo "<tr>";
            echo "<td style='border: 1px solid #ccc; padding: 8px;'>" . $row["idc"] . "</td>";
            echo "<td style='border: 1px solid #ccc; padding: 8px;'>" . $row["nombre"] . "</td>";
            echo "<td style='border: 1px solid #ccc; padding: 8px;'>" . $row["tipo"] . "</td>";
            echo '<td style="border: 1px solid #ccc; padding: 8px;">
              <a href="editar-examen.php?idc=' . $row["idc"] . '" class="btn btn-primary btn-sm">Editar</a>
              <a href="eliminar-examen.php?idc=' . $row["idc"] . '" class="btn btn-primary btn-sm" onclick="return confirm(\'¿Estás seguro de que desea eliminar este registro?\')">Eliminar</a>
            </td>';
            echo "</tr>"; 
          }
        } else {
