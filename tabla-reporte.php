...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <div class="py-5">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<td style="border: 1px solid #ccc; padding: 8px;">
                                <a href="editar-reporte.php?id_reporte=' . $row["id"] . '" class="btn btn-primary btn-sm">Editar</a>
                                <a href="eliminar-reporte.php?id=' . $row["id"] . '" class="btn btn-primary btn-sm" onclick="return confirm(\'¿Estás seguro de que desea eliminar este registro?\')">Eliminar</a>
                            </td>';
                            echo "</tr>";
                        }
                    } else {
        ...
        <div class="pie-form">
            <div class="py-5">
                <a class="nav-link btn btn-primary" href="reporte.php">Volver</a>
            </div>
        </div>
    </div>
