...
<header class="header header-mini"> 
    <div class="header-title">Ejemplo Examen </div> 
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE registro SET nombre='$nombre', correo='$tipo',  WHERE idc='$id'";
    ...
    if (isset($_GET["idc"])) {
        ...
        $sql = "SELECT * FROM examen WHERE idc='$id'";
        ...
        <table class="table">
          <thead>
            <tr>
              ...
              <th scope="col">
                <div class="py-5"></div>
                <input type="text" placeholder="Correo" name="tipo" value="<?php echo $tipo_actual; ?>" required>
                <div class="py-5"></div>
              </th>
              ...
              <th scope="col">
                ...
                <input class="btn btn-primary" type="submit" value="Guardar cambios" href="tabla-examen.php">
                <div class="py-5"></div>
              </th>
            </tr>
          </thead>
...
<div class="py-5">
    <div class="pie-form">
        <a class="nav-link btn btn-primary" href="consultas-examen.php">Finalizar.</a>
    </div> 
</div>
