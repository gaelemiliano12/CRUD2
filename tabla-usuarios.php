<?php
  ...
  $sql = "SELECT id, nombre, correo, contrasena FROM registro";
...
<header class="header header-mini"> 
 ...
 <div class="py-5">
    ...
    <table  class="table table-bordered" style="width: 70%; margin: 0 auto; border-collapse: collapse; border: 1px solid #ccc;">
      <thead>
        <tr>
          ...
          <th scope="col" style="border: 1px solid #ccc; padding: 8px;">Contraseña</th>
      ...
      <tbody>
        ...
        if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
            ...
            echo "<td style='border: 1px solid #ccc; padding: 8px;'>" . $row["correo"] . "</td>";
            echo "<td style='border: 1px solid #ccc; padding: 8px;'>" . $row["contrasena"] . "</td>";
            echo '<td style="border: 1px solid #ccc; padding: 8px;">
              <a href="editar-usuario.php?id=' . $row["id"] . '" class="btn btn-primary btn-sm">Editar</a>
              <a href="eliminar-usuario.php?id=' . $row["id"] . '" class="btn btn-primary btn-sm" onclick="return confirm(\'¿Estás seguro de que desea eliminar este registro?\')">Eliminar</a>
            </td>';
            echo "</tr>";
          }
        } else {
  ...
  <div class="pie-form">
  <div class="py-5">
  <a class="nav-link btn btn-primary" href="login.php">Volver</a>
 </div>
